...
export const AnnotationsPanel = ({
  ...
  return (
    <aside className={`${open ? 'w-80' : 'w-0'} flex-shrink-0 bg-[#171E24] border-l border-[#2A333B] overflow-hidden transition-[width] duration-300 z-20 absolute md:relative right-0 h-full`}>
